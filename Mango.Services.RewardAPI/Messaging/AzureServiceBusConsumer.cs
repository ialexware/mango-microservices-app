...
namespace Mango.Services.RewardAPI.Messaging
{
    public class AzureServiceBusConsumer : IAzureServiceBusConsumer
    {
        ...
        public AzureServiceBusConsumer(IConfiguration configuration, RewardService rewardService)
        {
            ...
            _rewardProcessor = cliente.CreateProcessor(orderCreatedTopic, orderCreatedRewardSubscription);
        ...
        {
            _rewardProcessor.ProcessMessageAsync += OnNewOrderRewardsRequesRecived;
            _rewardProcessor.ProcessErrorAsync += ErrorHandler;
            await _rewardProcessor.StartProcessingAsync();

        }

        private async Task OnNewOrderRewardsRequesRecived(ProcessMessageEventArgs args)
        {
